...
<html lang="es">
<head>
    <title>Iniciar Sesión – Obet's Store</title>
    <meta charset="utf-8" />
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .remember-row label { color: #555; margin: 0; }
        .remember-row a { color: var(--primary-dark); text-decoration: none; font-weight: 600; }
        .remember-row a:hover { text-decoration: underline; color: var(--primary-color); }
